    ...
    return (
      <>
          ...
          >
            ...
            >
              ...
              <svg
                ...
                className="h-5 w-5 arowIcon ms-2"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              >
                <img
                  src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
        ...
        <section id="services" className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="section-title text-4xl font-bold text-center text-gray-800">
              {t("specialized_services_title")}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-16">
              ...
              >
                <div className="h-56 overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1601422407692-ec4eeec1d9b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
              ...
              >
                <div className="h-56 overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
              ...
              >
                <div className="h-56 overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1607962837359-5e7e89f86776?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
              ...
              >
                <div className="h-56 overflow-hidden">
                  <img
                    src="https://images.unsplash.com/photo-1588286840104-8957b019727f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1470&q=80"
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex items-start group">
                    <div
                      className="flex-shrink-0 bg-blue-100 rounded-full p-4 flex items-center justify-center mr-4 
                    ...
                    <div>
                      <h4 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors duration-300">
                        {t("approach_assessment_title")}
                      </h4>
                      <p className="text-gray-600">
                        {t("approach_assessment_desc")}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors duration-300">
                        {t("approach_treatment_title")}
                      </h4>
                      <p className="text-gray-600">
                        {t("approach_treatment_desc")}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors duration-300">
                        {t("approach_monitoring_title")}
                      </h4>
                      <p className="text-gray-600">
                        {t("approach_monitoring_desc")}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div>
                      <h4 className="text-xl font-semibold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors duration-300">
                        {t("approach_education_title")}
                      </h4>
                      <p className="text-gray-600">
                        {t("approach_education_desc")}
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-12">
              {/* Team Member 1 */}
              <div
                className="team-card bg-white overflow-hidden shadow-lg rounded-xl"
                data-aos="fade-up"
                data-aos-duration="800"
              >
            ...
            >
              <NavigationLink
                ...
                className="inline-flex items-center bg-blue-600 text-white hover:bg-blue-700 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg"
              >
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              {/* Technology 1 */}
              <div
                className="technology-card bg-gray-50 p-8 rounded-xl border border-gray-200 shadow-md hover:shadow-xl transition-shadow duration-300"
                data-aos="fade-up"
                data-aos-duration="800"
              >
                ...
                <div className="tech-feature-list flex flex-col space-y-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">
                      {t("tech_graston_feature1")}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_graston_feature2")}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_graston_feature3")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="tech-feature-list flex flex-col space-y-3">
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_electro_feature1")}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_electro_feature2")}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_electro_feature3")}
                    </span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="tech-feature-list flex flex-col space-y-3">
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_ultrasound_feature1")}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_ultrasound_feature2")}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <i className="fas fa-check-circle text-green-500 mr-3"></i>
                    <span className="text-gray-700">
                      {t("tech_ultrasound_feature3")}
                    </span>
                  </div>
                </div>
              </div>
