    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl text-white">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6 animate-slide-left">
              {t("hero_title")}
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl mb-8 opacity-90 animate-slide-right">
              {t("bod")} - {t("hero_subtitle")}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-up">
              <Link
                href="/about"
                className="bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-md font-medium transition duration-300 text-base sm:text-lg transform hover:scale-105 text-center"
              >
                {t("learn_more")}
              </Link>
              <Link
                href="/contact"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-800 px-6 sm:px-8 py-3 sm:py-4 rounded-md font-medium transition duration-300 text-base sm:text-lg transform hover:scale-105 text-center"
              >
                {t("contact_us")}
              </Link>
            </div>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 md:animate-bounce">
          <svg
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12 fade-in-left">
              ...
              <p className="text-gray-600 mb-6">{t("about_desc1")}</p>
              <p className="text-gray-600 mb-6">{t("about_desc2")}</p>
              <Link
                href="/about"
      ...
      <section className="py-8 sm:py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 md:gap-8 subsidiaries-grid">
            {/* Subsidiary 1 - LO Uniforms */}
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300 subsidiary-card">
              <div className="h-48 bg-gray-200 flex items-center justify-center overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src =
                      "https://images.unsplash.com/photo-1514866747592-c2d279258a78?ixlib=rb-4.0.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80";
                  }}
                />
              </div>
              ...
              <div className="h-48 bg-gray-200 flex items-center justify-center overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://images.unsplash.com/photo-1581578731548-c64695cc6952?ixlib=rb-4.0.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80";
                  }}
                />
              </div>
              <div className="p-4 sm:p-6">
              ...
              <div className="h-48 bg-gray-200 flex items-center justify-center overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80";
                  }}
                />
              </div>
              <div className="p-4 sm:p-6">
              ...
              <div className="h-48 bg-gray-200 flex items-center justify-center overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://images.unsplash.com/photo-1507679799987-c456f719a1fc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80";
                  }}
                />
              </div>
              <div className="p-4 sm:p-6">
                ...
                <Link
                  href="/subsidiaries/completed-tasks"
                  className="text-blue-600 hover:text-blue-800 font-medium text-sm sm:text-base"
                >
                  {t("learn_more")} →
                </Link>
              ...
              <div className="h-48 bg-gray-200 flex items-center justify-center">
                <img
                  ...
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src =
                      "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80";
                  }}
                />
              </div>
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">{t("subsidiary13_desc")}</p>
                <a
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 stagger-animation">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">{t("tech_desc")}</p>
              <Link
                href="/sectors#technology"
                className="text-blue-800 hover:text-blue-700 font-medium inline-flex items-center"
              >
                {t("learn_more")}
                <svg
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              <div className="flex justify-center items-center text-blue-800 text-4xl mb-6">
                <img
                  src="https://cdn-icons-png.flaticon.com/512/1786/1786046.png"
                  alt="Manufacturing Icon"
                  className="w-16 h-16 mb-4"
                />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 mb-2">
                {t("manufacturing_sector")}
              </h3>
              <p className="text-gray-600 mb-4">{t("manufacturing_desc")}</p>
              <Link
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">{t("healthcare_desc")}</p>
              <Link
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">{t("automotive_desc")}</p>
              <Link
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-2">
                {t("hospitality_sector")}
              </h3>
              <p className="text-gray-600 mb-4">{t("hospitality_desc")}</p>
              <Link
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              <div className="flex justify-center items-center text-blue-800 text-4xl mb-6">
                <img
                  src="https://cdn-icons-png.flaticon.com/512/3233/3233479.png"
                  alt="Services Icon"
                  className="w-16 h-16 mb-4"
                />
              </div>
              ...
              <p className="text-gray-600 mb-4">{t("services_desc")}</p>
              <Link
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg transform transition duration-500 hover:scale-105">
              ...
              <p className="text-gray-600 mb-4">{t("retail_desc")}</p>
              <Link
                href="/sectors#retail"
                className="text-blue-800 hover:text-blue-700 font-medium inline-flex items-center"
              >
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center scale-up">
          ...
          <p className="text-xl max-w-3xl mx-auto mb-8">{t("cta_desc")}</p>
      ...
      <style jsx>{`
        ...
        .hero-bg {
          ...
          background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
            url("https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80")
